...
define(["require", "exports", "moment", "../src/common/chartModels", "../src/transformers/limitVisResults", "../src/transformers/chartAggregation"], function (require, exports, moment, chartModels_1, limitVisResults_1, chartAggregation_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    moment['suppressDeprecationWarnings'] = true;
    describe('Unit tests for LimitVisResults', function () {
        //#region Private members
        var exceedMaxDataPointLabel = 'Unique label';
        var maxUniqueXValues = 2;
        var originalRows;
        var emptyLimitedResults;
        //#endregion Private members
        //#region Private methods
        function triggerLimitAllRows(limitAndAggregateParams, limitedResults) {
            var aggregationMethod = chartAggregation_1.ChartAggregation.getAggregationMethod(limitAndAggregateParams.aggregationType);
            var internalParams = __assign({ aggregationMethod: aggregationMethod }, limitAndAggregateParams);
            // Act
            limitVisResults_1.LimitVisResultsSingleton['limitAllRows'](internalParams, limitedResults);
        }
        ...
        beforeEach(function (done) {
            ...
            emptyLimitedResults = new limitVisResults_1.LimitedResults();
            done();
        });
        //#endregion Generate mocks and defaults
        //#region Tests
        describe('Validate limitAllRows method', function () {
            it("When X and Filter values don't exceed maximum, they aren't limited", function () {
                var originalRows = [
                    ['Israel', 'Tel Aviv', 10],
            ...
            it("When X values exceeds maximum size, the X values are limited", function () {
                var limitAndAggregateParams = {
                    queryResultData: { rows: originalRows, columns: [] },
                    indexOfXColumn: 1,
                    indexesOfYColumns: [3],
            ...
            it("When X values are DateTime, and Filter exceeds maximum size, only Filter values are limited", function () {
                var limitAndAggregateParams = {
                    queryResultData: { rows: originalRows, columns: [] },
                    indexOfXColumn: 0,
            ...
            it("When both X values and Filter values exceeds maximum size, both of them are limited", function () {
                var limitAndAggregateParams = {
                    queryResultData: { rows: originalRows, columns: [] },
                    indexOfXColumn: 1,
                    indexesOfYColumns: [3, 4],
            ...
            it("When there are 2 Filter values, and both of them exceeds maximum size, both of them are limited", function () {
                var originalRows = [
                    ['X', 'a', 1, 'aa'],
                    ['X', 'b', 2, 'bb'],
                    ['X', 'c', 3, 'bb'],
            ...
            it("Average aggregation - When both X values and Filter values exceeds maximum size, both of them are limited", function () {
                ...
                var limitAndAggregateParams = {
                    ...
                    indexesOfSplitByColumns: [2],
                    xColumnType: chartModels_1.DraftColumnType.String,
                    aggregationType: chartModels_1.AggregationType.Average,
                    maxUniqueXValues: maxUniqueXValues,
                    otherStr: exceedMaxDataPointLabel
                };
                // Act
        ...
        describe('Validate limitAndAggregateRows method', function () {
            var originalRows = [
            ...
            it("When the X and the SpliBy have the same values, those values are aggregated", function () {
                var limitAndAggregateParams = {
                    queryResultData: { rows: originalRows, columns: [] },
                    indexOfXColumn: 0,
                    indexesOfYColumns: [4],
            ...
            it("When the X have the same value, and there is no split-by, the X values are aggregated", function () {
                var limitAndAggregateParams = {
                    queryResultData: { rows: originalRows, columns: [] },
                    indexOfXColumn: 2,
                    indexesOfYColumns: [4],
            ...
            it("When the X values exceeds maximum size, they are limited", function () {
                var limitAndAggregateParams = {
                    queryResultData: { rows: originalRows, columns: [] },
                    indexOfXColumn: 2,
                    indexesOfYColumns: [4],
...
//# sourceMappingURL=limitVisResults.test.js.map