export declare enum DraftColumnType {
    Bool = "bool",
    DateTime = "datetime",
    Decimal = "decimal",
    Dynamic = "dynamic",
...
export declare type IRowValue = string | number;
export declare type ISeriesRowValue = IRowValue | string[] | number[];
export declare type IRow = IRowValue[];
export declare type ISeriesRow = ISeriesRowValue[];
